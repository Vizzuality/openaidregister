  ...
  var AjaxModal = Modal.extend({
    ...
    initialize: function() {
      _.bindAll(this, '_renderForm', '_setNewForm', '_addNewProject');
      
      // To get the new forms magically :S
      $('body').bind('project_loaded', this._setNewForm);
      // New project added?
      $('body').bind('new',       this._addNewProject);
    ...
    _addNewProject: function(e,data) {
      if (this.collection)
    ...
    clean: function() {
      ...
      $('body').unbind('project_loaded',  this._setNewForm);
      $('body').unbind('new',             this._addNewProject);
      this.remove();
    }
  })