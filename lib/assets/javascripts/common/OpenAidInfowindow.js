function OpenAidInfowindow(map) {
  ...
  this.div_ = null;
  this.map_ = map;
  this.dates = [ "Jan", "Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Sep", "Oct", "Nov", "Dec" ];
  this.setMap(map);
}
...
OpenAidInfowindow.prototype.setContent = function(content){
  if (this.div_) {
    ...
    $(div).find('p').text(this.dates[start_date.getMonth()] + " " + start_date.getFullYear() + " - " + this.dates[end_date.getMonth()] + " " + end_date.getFullYear());
  }
};
